  ...
  return (
    <div className={styles.page}>
      <div className={styles.header}>
        ...
        <p className={styles.subtitle}>Navigate the corrupted realms. Start heists by clicking zones on the map.</p>
      </div>
      ...
      <AnimatePresence>
        {selectedHeist && (
          selectedHeist.type === 'knapsack' ? (
           <KnapsackHeist heist={selectedHeist} onClose={() => setSelectedHeist(null)} onComplete={handleHeistComplete} />
          ) : selectedHeist.type === 'tsp' ? (
            <TSPHeist heist={selectedHeist} onClose={() => setSelectedHeist(null)} onComplete={handleHeistComplete} />
          ) : (
            <GraphHeist heist={selectedHeist} onClose={() => setSelectedHeist(null)} onComplete={handleHeistComplete} />
        )
    )}
      </AnimatePresence>
    </div>
